...
<html>
    ...
    <body>
          ...
          <section id="edit">
              ...
              <div align="center"><h5 align="center"><span class="image left special"><img src="images/fulls/09.jpg" height="260" width="" alt=""><a class="button" value="alterar">alterar imagem</a></span></h5></div>
                    <h4  align="left">
                        <form action="#" method="post">
                            <div class="field half">
                                <label for="nameM">Nome da memória</label>
								<input name="nameM" id="nameM" type="text" placeholder="O basket do primeiro Ano">
                            </div>
